        ...
        <div style={{
            ...
            <div className="login-card" style={{ width: "100%", maxWidth: 420, position: "relative", zIndex: 10 }}>
                ...
                <div style={{ textAlign: "center", marginBottom: 32 }}>
                    <div style={{ position: "relative", width: 72, height: 72, margin: "0 auto 16px", borderRadius: "50%", background: "linear-gradient(135deg,#f59e0b,#f97316)", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 0 40px rgba(245,158,11,0.4)" }}>
                    ...
                    <div style={{ padding: 28 }}>
                        {!success ? (
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div style={{ marginBottom: 20 }}>
                                        ...
                                        <div style={{ position: "relative" }}>
                                            <FaEnvelope size={13} style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", color: "rgba(255,255,255,0.3)" }} />
                                            <input
                                                type="email"
                            ...
                            <div style={{ textAlign: "center", padding: "16px 0" }}>
                                <div style={{ width: 64, height: 64, background: "rgba(16,185,129,0.15)", border: "1px solid rgba(16,185,129,0.3)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px", fontSize: 28 }}>
                                    📧
                                </div>
                                <h2 style={{ color: "#fff", fontWeight: 800, fontSize: 20, margin: "0 0 8px" }}>Check Your Email</h2>
                                <p style={{ color: "rgba(255,255,255,0.4)", fontSize: 13, marginBottom: 6 }}>Reset link sent to</p>
                                <p style={{ color: "#f59e0b", fontWeight: 700, fontSize: 14, marginBottom: 16 }}>{email}</p>
                                ...
                                <button onClick={() => { setSuccess(false); setEmail(""); }}
                                    style={{ background: "none", border: "none", color: "rgba(251,191,36,0.7)", fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "'DM Sans',sans-serif" }}>
