...
import { useNavigate, useLocation, Link } from "react-router-dom"; // ✅ useLocation added
...
const AdminLogin = () => {
    ...
    const submit = async (e) => {
        ...
        try {
            ...
            // ✅ Redirect back to the page user was trying to access, fallback /admin
                    ...
                    <form onSubmit={submit} style={{ padding: 28 }}>
                        ...
                        {error && (
                            <div
                                className="shake"
                                key={error}
                                style={{ background: "rgba(239,68,68,0.15)", border: "1px solid rgba(239,68,68,0.3)", color: "#fca5a5", padding: "10px 14px", borderRadius: 12, fontSize: 13, marginBottom: 16, display: "flex", alignItems: "center", gap: 8 }}
                            >
                                ⚠️ {error}
                            </div>
                        )}
                        ...
                        <div style={{ marginBottom: 16 }}>
                            ...
                            <div style={{ position: "relative" }}>
                                <FaEnvelope
                                    size={13}
                                    style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", color: focused === "email" ? "#f59e0b" : "rgba(255,255,255,0.3)", transition: "color 0.2s", pointerEvents: "none" }}
                                />
                                <input
                                    type="email"
                        ...
                        <div style={{ marginBottom: 24 }}>
                            ...
                            <div style={{ position: "relative" }}>
                                <FaLock
                                    size={13}
                                    style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", color: focused === "password" ? "#f59e0b" : "rgba(255,255,255,0.3)", transition: "color 0.2s", pointerEvents: "none" }}
                                />
                                <input
                        ...
                        <button
                            ...
                            style={{ width: "100%", padding: "14px", border: "none", borderRadius: 12, color: "#fff", fontWeight: 800, fontSize: 15, cursor: loading ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, fontFamily: "'DM Sans',sans-serif" }}
                        >
                            {loading ? (
                                <>
