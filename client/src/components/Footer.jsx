        ...
        <footer style={{ background: "#0a0d12", color: "#94a3b8", fontFamily: "'DM Sans', sans-serif" }} className="mt-auto">
            ...
            <div className="ftr-root">
                ...
                <div style={{ maxWidth: 1280, margin: "0 auto", padding: "60px 24px 0" }}>
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "48px 40px", marginBottom: 48 }}>
                        ...
                        <div>
                            ...
                            <div style={{ display: "flex", gap: 8 }}>
                                {[
                                    { href: "https://www.facebook.com/share/1aQqqv6Ewg/", icon: <FaFacebookF size={12} />, label: "Facebook" },
                                    { href: "https://www.instagram.com/rv_gift_shop_and_printing/", icon: <FaInstagram size={12} />, label: "Instagram" },
                                    { href: "https://wa.me/918299519532", icon: <FaWhatsapp size={12} />, label: "WhatsApp" },
                                ].map(({ href, icon, label }) => (
                        ...
                        <div>
                            ...
                            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 12 }}>
                                {/* ✅ /products redirects to / via AppRoutes — no comment inside array */}
                                {[
                                    { to: "/", label: "Home" },
                        ...
                        <div>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                                <a href="https://maps.app.goo.gl/bpjDdpu4dJL3DcvT9" target="_blank" rel="noopener noreferrer" className="ftr-contact-row">
                                    <div className="ftr-contact-icon"><FaMapMarkerAlt size={11} color="#c9973a" /></div>
                                    <span>
                                ...
                                <a href="tel:+918299519532" className="ftr-contact-row">
                                    <div className="ftr-contact-icon"><FaPhoneAlt size={11} color="#c9973a" /></div>
                                    +91 82995 19532, +91 97927 70976
                                </a>
                                <a href="mailto:officialrvgift@gmail.com" className="ftr-contact-row">
                                    <div className="ftr-contact-icon"><FaEnvelope size={11} color="#c9973a" /></div>
                    ...
                    <div className="ftr-bottom">
                        ...
                        <p style={{ fontSize: 12, color: "#334155", margin: 0 }}>
                            Designed by{" "}
                            <a href="https://www.linkedin.com/in/dhananjaypa" target="_blank" rel="noopener noreferrer"
                                style={{ color: "#c9973a", textDecoration: "none", fontWeight: 600 }}>
                                Dhananjay Pandey
                            </a>
                        </p>
                    </div>
